...
soft=nodes.new('ShaderNodeMath');soft.operation='POWER';soft.inputs[1].default_value=1.4;links.new(falloff.outputs['Result'],soft.inputs[0])
...
contrast=nodes.new('ShaderNodeMapRange');contrast.inputs['From Min'].default_value=.30;contrast.inputs['From Max'].default_value=.68;contrast.inputs['To Min'].default_value=0;contrast.inputs['To Max'].default_value=2;contrast.clamp=True;links.new(noise.outputs['Fac'],contrast.inputs['Value'])
