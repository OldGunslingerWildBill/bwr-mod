...
for name in ('wall','rim','suction','return','steam_inlet','heat_exchanger','water_surface','spray_rail','spray_riser'):
    ...
    model['automatic_culling']=name in ('wall','rim','suction','return','steam_inlet')
