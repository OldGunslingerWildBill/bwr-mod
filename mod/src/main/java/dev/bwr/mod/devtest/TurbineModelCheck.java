...
public final class TurbineModelCheck {
    ...
    public static void baked(ModelEvent.BakingCompleted event) {
        ...
        if(!Boolean.getBoolean("bwr.machineRenderCheck") && !Boolean.getBoolean("bwr.terryPanelCheck") && !Boolean.getBoolean("bwr.alphaClientCheck") && !Boolean.getBoolean("bwr.pumpPanelCheck") && !Boolean.getBoolean("bwr.powerPanelCheck") && !Boolean.getBoolean("bwr.condenserPanelCheck") && !Boolean.getBoolean("bwr.coolingPanelCheck") && !Boolean.getBoolean("bwr.tankPanelCheck") && !Boolean.getBoolean("bwr.compactCorePanelCheck") && !Boolean.getBoolean("bwr.vesselModelCheck") && !Boolean.getBoolean("bwr.suppressionPanelCheck") && !Boolean.getBoolean("bwr.guiPerformanceCheck") && !Boolean.getBoolean("bwr.creativePerformanceCheck")) Minecraft.getInstance().execute(() -> Minecraft.getInstance().stop());
    }
}
