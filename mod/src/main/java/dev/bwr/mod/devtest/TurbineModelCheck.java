...
public final class TurbineModelCheck {
    ...
    public static void baked(ModelEvent.BakingCompleted event) {
        ...
        if(!Boolean.getBoolean("bwr.pumpPanelCheck") && !Boolean.getBoolean("bwr.powerPanelCheck") && !Boolean.getBoolean("bwr.condenserPanelCheck") && !Boolean.getBoolean("bwr.coolingPanelCheck") && !Boolean.getBoolean("bwr.tankPanelCheck") && !Boolean.getBoolean("bwr.compactCorePanelCheck") && !Boolean.getBoolean("bwr.vesselModelCheck") && !Boolean.getBoolean("bwr.suppressionPanelCheck")) Minecraft.getInstance().execute(() -> Minecraft.getInstance().stop());
    }
}
