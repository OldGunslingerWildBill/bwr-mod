...
public class CoolingMenu extends BwrMenu {
    ...
    public double input,output,flow,loss,heat,target,actual,inputC,outputC;public int energy,draw;
    ...
    @Override protected void writeSnapshot(FriendlyByteBuf b){
        ...
        for(double n:new double[]{u.input(),u.output(),u.flow(),u.loss(),u.heatMW(),be.target(),be.actual(),u.inputC(),u.outputC()})b.writeDouble(n);
    ...
    @Override protected void readSnapshot(FriendlyByteBuf b){
        ...
        input=b.readDouble();output=b.readDouble();flow=b.readDouble();loss=b.readDouble();heat=b.readDouble();target=b.readDouble();actual=b.readDouble();inputC=b.readDouble();outputC=b.readDouble();energy=b.readInt();draw=b.readInt();
    }
