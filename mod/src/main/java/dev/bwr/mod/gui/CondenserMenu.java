...
/** Reachability uses the clicked part, since the far ports are 25 blocks from the foundation. */
public class CondenserMenu extends BwrMenu {
    private final BlockPos anchor;
    public boolean present, ready;
    public double cold,hot,condensate,steam,steamRate,coolingRate,rejectedMW;
    ...
    @Override protected void writeSnapshot(FriendlyByteBuf b){
        ...
        for(double n:new double[]{p.cold(),p.hot(),p.condensate(),p.steam.mass(),p.steamRate(),p.coolingRate(),p.rejectedMW()})b.writeDouble(n);
    }
    @Override protected void readSnapshot(FriendlyByteBuf b){
        ...
        steam=b.readDouble();steamRate=b.readDouble();coolingRate=b.readDouble();rejectedMW=b.readDouble();
    }
