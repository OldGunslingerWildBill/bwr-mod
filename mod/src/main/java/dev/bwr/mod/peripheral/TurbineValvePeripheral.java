...
public final class TurbineValvePeripheral implements IPeripheral {
    ...
    @Override public String getType(){return valve.stopValve()?"bwr_steam_stop_valve":"bwr_turbine_control_valve";}
    ...
    @LuaFunction(mainThread=true) public Map<String,Object> getStatus(){return Map.of("target",valve.target(),"position",valve.position(),"turbineSteamKgPerS",valve.flowKgPerS(),"stopValve",valve.stopValve());}
}
